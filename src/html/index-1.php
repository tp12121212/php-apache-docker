...
<body id="menu" class="body-page">
    ...
    <div class="cover-page">
        <!-- Cover Background -->
        <div class="cover-bg">
            <img class="fit" src="https://cdn.killercloud.com.au/web/img/bg-default-2.jpg" alt="cover">
        </div>

        <!-- Gradient mask -->
        <div class="cover-bg bg-black opacity-6"></div>
    </div>
    <!--END OF page cover -->
    ...
    <main class="page-main sections-scroll scroll-anim" id="mainpage">
                    ...
                    <div class="row justify-content-center text-center">
                        <div class="content-col col-12 col-md-8 col-lg-8">
                            ...
                            <div class="title-desc">
                                <h1 data-scroll data-scroll-speed="1" class="display-title hero-title anim-1">Simpleux
                                </h1>
                                <p data-scroll data-scroll-speed="3" class="anim-2 hero-desc">Small business based in
                                    Antartica, we work
                                    to make a better product for you.</p>
                            </div>
        ...
        <section id="pricing" class="section section-a fullscreen-h-lg">
            <div class="section-title title-anim">
                <div data-anim-visible='zoom-in'>
                    ...
                    <div class="swiper-container slider-simple-a animated">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide slide-item-a">
                                <div class="item-wrapper">
                                    <div class="item-image rounded-md">
                                        <img src="https://cdn.killercloud.com.au/web/img/items/img-sample2.jpg"
                                            alt="image">
                                    </div>
                            ...
                            <div class="swiper-slide slide-item-a">
                                <div class="item-wrapper">
                                    <div class="item-image rounded-md">
                                        <img src="https://cdn.killercloud.com.au/web/img/items/img-sample3.jpg"
                                            alt="image">
                                    </div>
                                    <div class="item-content">
                                        <h5 class="subtitle">Projects</h5>
                            ...
                            <div class="swiper-slide slide-item-a">
                                <div class="item-wrapper">
                                    <div class="item-image rounded-md">
                                        <img src="https://cdn.killercloud.com.au/web/img/items/img-sample5.jpg"
                                            alt="image">
                                    </div>
                                    <div class="item-content">
                                        <h5 class="subtitle">Projects</h5>
        ...
        <section id="work-item" class="section section-a fullscreen-h-lg">
                        ...
                        <div class="row g-5">
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="item item-image-c rounded-md" data-anim-visible='fade'>
                                    <div class="item-img">
                                        <img class="fit"
                                            src="https://cdn.killercloud.com.au/web/img/items/img-square-1.jpg"
                                            alt="team member">
                                    </div>
                            ...
                            <div class="col-12 col-lg-6 d-flex align-items-center">
                                <div class="title-desc pe-lg-5 ps-lg-5" data-anim-visible='fade'>
                                    <p>This thing was made from the finest technology and materials available on earth.
                                        It is so
                                        special that it is unique in every aspect.</p>
        ...
        <section id="products" class="section section-a fullscreen-h-lg">
