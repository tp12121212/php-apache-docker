...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.killercloud.com.au/web/js/fullpage/jquery.fullpage.min.css">
...
<body id="menu" class="body-page">
    ...
    <nav class="nav-sidebar d-none d-xl-block">
        <ul class="nav-wrapper fp-menu">
            ...
            <li class="nav-item" data-menuanchor="works">
    ...
    <div class="cover-page">
        <!-- Cover Background -->
        <div class="cover-bg">
            <img class="fit" src="https://cdn.killercloud.com.au/web/img/bg-default.jpg" alt="cover">
        </div>

        <!-- Transluscent mask as filter -->
        <!-- BEGIN OF Slideshow Background - uncomment below to use background slideshow-->
        <div class="cover-bg slide-show">
            <i class='img' data-src='./img/bg-default-3.jpg'></i>
            <i class='img' data-src='./img/bg-default-4.jpg'></i>
            <i class='img' data-src='./img/bg-default-2.jpg'></i>
            <i class='img' data-src='./img/bg-default-1.jpg'></i>
        </div>
    ...
    <main class="page-main page-fullpage scroll-anim" id="mainpage">

        <!-- Begin of hero section -->
        <section class="section hero-a fp-auto-height-responsive " data-section="home">
                    ...
                    <div class="row">
                        <div class="content-col col-12 col-md-8 col-lg-6 text-left">
                            ...
                            <div class="title-desc">
                                <h1 class="display-title hero-title anim-1">Simpleux</h1>
                                <p class="anim-2 hero-desc">A simple layout design made by designer and coders. Build
                                    for any
                                    projects, and for creative people.</p>
                            </div>
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="about">
                        ...
                        <div class="col-12 col-lg-8 text-left">
                            ...
                            <div class="title-desc">
                                ...
                                <div class="anim-2" data-anim-visible='fade'>
                                    <p>Kompany is an agency specialized in building brands and startup, we are
                                        a team of cool people wanting to develop cool and smart technologies out of
                                        something
                                        simple.</p>
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="services">
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="team">
                            ...
                            <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 anim-list">
                                ...
                                <div class="col">
                                    ...
                                    <div class="item item-image-a " data-anim-visible='fade'>
                                        <a class="img  rounded-pill" href="#userpage">
                                            <img class="fit"
                                                src="https://cdn.killercloud.com.au/web/img/items/img-person4.jpg"
                                                alt="team member">
                                        </a>
                                        <div class="item-body mt-4">

                                            <a class="page-link" href="#userpage">
                                                <h4>Peter Laplace</h4>
                                                <p>Designer / CEO</p>
                                            </a>
                                            <nav class="nav-social nav-social-a">
                                ...
                                <div class="col">
                                    ...
                                    <div class="item item-image-a " data-anim-visible='fade'>
                                        <a class="img  rounded-pill" href="#userpage">
                                            <img class="fit"
                                                src="https://cdn.killercloud.com.au/web/img/items/img-person2.jpg"
                                                alt="team member">
                                        </a>
                                        <div class="item-body mt-4">
                                ...
                                <div class="col">
                                    ...
                                    <div class="item item-image-a " data-anim-visible='fade'>
                                        <a class="img  rounded-pill" href="#userpage">
                                            <img class="fit"
                                                src="https://cdn.killercloud.com.au/web/img/items/img-person3.jpg"
                                                alt="team member">
                                        </a>
                                        <div class="item-body mt-4">
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="pricing">
            <div class="section-title title-anim">
                <div data-anim-visible='zoom-in'>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-8 text-left">
                            ...
                            <div class="title-desc" data-anim-visible='fade'>
                                ...
                                <p class="anim-2">These are our flexible pricing plan. Choose the one that fits your
                                    need. You
                                    can always change plan later.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 anim-list">
                                <div class="col">
                                    ...
                                    <div class="item item-pricing-a rounded-md" data-anim-visible='fade'>
                                        ...
                                        <div class="item-footer">
                                            <a class="btn btn-solid btn-white btn-full" href="#">
                                ...
                                <div class="col">
                                    ...
                                    <div class="card item-pricing-a rounded-md featured" data-anim-visible='fade'>
                                        ...
                                        <div class="item-footer">
                                            <a class="btn btn-solid btn-primary btn-full" href="#">
                                                <span class="text">Choose Plan</span>
                                            </a>
                                        </div>
                                    </div>
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="works">
                    ...
                    <div class="row mb-4">
                        <div class="col-12 col-lg-8 text-left">
                            ...
                            <div class="title-desc" data-anim-visible='fade'>
                                ...
                                <p class="anim-2">We did so many projects since the beginning of our path. Here are some
                                    of the
                                    remarkable ones.</p>
                            </div>
                        </div>
                                ...
                                <div class="row row-cols-1 g-5">
                                    <div class="col">
                                        ...
                                        <a class="item item-image-b col-12 col-lg-9" href="#" data-anim-visible='fade'>
                                            <div class="item-img rounded-md">
                                                <img class="fit"
                                                    src="https://cdn.killercloud.com.au/web/img/items/img-portrait1.jpg"
                                                    alt="team member">
                                            </div>
                                            <div class="item-body">
                                                <div class="desc">
                                    ...
                                    <div class="col">
                                        ...
                                        <a class="item item-image-b" href="#" data-anim-visible='fade'>
                                            <div class="item-img rounded-md">
                                                <img class="fit"
                                                    src="https://cdn.killercloud.com.au/web/img/items/img-sample1.jpg"
                                                    alt="team member">
                                            </div>
                                            <div class="item-body">
                                                <div class="desc">
                                ...
                                <div class="row row-cols-1 g-5">
                                    <div class="col">
                                        ...
                                        <a class="item item-image-b" href="#" data-anim-visible='fade'>
                                            <div class="item-img rounded-md">
                                                <img class="fit"
                                                    src="https://cdn.killercloud.com.au/web/img/items/img-sample4.jpg"
                                                    alt="team member">
                                            </div>
                                            <div class="item-body">
                                                <div class="desc">
                                    ...
                                    <div class="col d-flex justify-content-end">
                                        <!-- card -->
                                        <a class="item item-image-b col-12 col-lg-9 text-right" href="#"
                                            data-anim-visible='fade'>
                                            <div class="item-img rounded-md">
                                                <img class="fit"
                                                    src="https://cdn.killercloud.com.au/web/img/items/img-portrait2.jpg"
                                                    alt="team member">
                                            </div>
                                            <div class="item-body">
                                                <div class="desc">
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="products">
                    ...
                    <div class="row mb-4">
                        <div class="col-12 col-lg-8 text-left">
                            ...
                            <div class="title-desc" data-anim-visible='fade'>
                                ...
                                <p class="anim-2">We made so many products since the beginning of our path. Here are
                                    some of the
                                    remarkable ones.</p>
                            </div>
                        </div>
                        ...
                        <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-3 g-5 anim-list">
                            <div class="col">
                                ...
                                <a class="item item-image-b" href="#" data-anim-visible='fade'>
                                    <div class="item-img rounded-md">
                                        <img class="fit"
                                            src="https://cdn.killercloud.com.au/web/img/items/img-square-2.jpg"
                                            alt="team member">
                                    </div>
                                    <div class="item-body">
                                        <div class="desc">
                            ...
                            <div class="col">
                                ...
                                <a class="item item-image-b" href="#" data-anim-visible='fade'>
                                    <div class="item-img rounded-md">
                                        <img class="fit"
                                            src="https://cdn.killercloud.com.au/web/img/items/img-square-3.jpg"
                                            alt="team member">
                                    </div>
                                    <div class="item-body">
                                        <div class="desc">
                            ...
                            <div class="col">
                                ...
                                <a class="item item-image-b" href="#" data-anim-visible='fade'>
                                    <div class="item-img rounded-md">
                                        <img class="fit"
                                            src="https://cdn.killercloud.com.au/web/img/items/img-square-4.jpg"
                                            alt="team member">
                                    </div>
                                    <div class="item-body">
                                        <div class="desc">
                            ...
                            <div class="col">
                                ...
                                <a class="item item-image-b" href="#" data-anim-visible='fade'>
                                    <div class="item-img rounded-md">
                                        <img class="fit"
                                            src="https://cdn.killercloud.com.au/web/img/items/img-square-5.jpg"
                                            alt="team member">
                                    </div>
                                    <div class="item-body">
                                        <div class="desc">
                            ...
                            <div class="col">
                                ...
                                <a class="item item-image-b" href="#" data-anim-visible='fade'>
                                    <div class="item-img rounded-md">
                                        <img class="fit"
                                            src="https://cdn.killercloud.com.au/web/img/items/img-square-6.jpg"
                                            alt="team member">
                                    </div>
                                    <div class="item-body">
                                        <div class="desc">
                            ...
                            <div class="col">
                                ...
                                <a class="item item-image-b" href="#" data-anim-visible='fade'>
                                    <div class="item-img rounded-md">
                                        <img class="fit"
                                            src="https://cdn.killercloud.com.au/web/img/items/img-square-7.jpg"
                                            alt="team member">
                                    </div>
                                    <div class="item-body">
                                        <div class="desc">
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="subscribe">
            <div class="section-title title-anim">
                <div data-anim-visible='zoom-in'>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-12 col-lg-6 text-left">
                            ...
                            <div class="title-desc pe-lg-5" data-anim-visible='fade'>
                                ...
                                <p class="anim-2">Don't miss any new opportunity, Hurry up! register now and get early
                                    access
                        ...
                        <div class="col-12 col-lg-5 text-left">
                            <form id="form-subscribe" class="form-a form-subscribe" method="post"
                                action="ajaxserver/serverfile.php" data-anim-visible='fade'>
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="reviews">
            <div class="section-title title-anim">
                <div data-anim-visible='zoom-in'>
                    ...
                    <div class="row justify-content-between">
                        <div class="col-12 col-lg-6 text-left">
                            ...
                            <div class="title-desc pe-lg-5" data-anim-visible='fade'>
                                ...
                                <p class="anim-2">Here are some user feedback about our services and how they help them
                                    achieve
                                    their goals.</p>
                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="item-slider item-quote-a">
                                            <div class="item-body">
                                                <blockquote class="quote">
                                                    <span class="quote-icon">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="37.002"
                                                            height="33.114" viewBox="0 0 37.002 33.114">
                                                            <path data-name="Path 4"
                                                                ...
                                                                transform="translate(0.551 0.5)"
                                                                fill="rgba(255,255,255,0.07)" stroke="#fff"
                                                                stroke-width="1" />
                                                        </svg>
                                                    </span>
                                                    <span>
                                                        We can tell our relatives that we did the best choice when
                                                        choosing it. One word: amazing !
                                                    </span>
                                                </blockquote>
                                            </div>
                                            <div class="item-header">
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <img class="icon-img-lg rounded-pill"
                                                            src="https://cdn.killercloud.com.au/web/img/items/img-avatar-1.jpg"
                                        ...
                                        <div class="item-slider item-quote-a">
                                            ...
                                            <div class="item-header">
                                                <div class="row">
                                                    <div class="col-auto">
                                                        <img class="icon-img-lg rounded-pill"
                                                            src="https://cdn.killercloud.com.au/web/img/items/img-avatar-2.jpg"
                                                            loading="lazy" alt="Item">
                                                    </div>
                                                    <div class="col">
        ...
        <section class="section section-a fp-auto-height-responsive " data-section="contact">
            <div class="section-title title-anim">
                <div data-anim-visible='zoom-in'>
                ...
                <div class="section-content container content-width anim">
                        ...
                        <div class="col-12 col-lg-6 text-left">
                            ...
                            <div class="title-desc">
                                ...
                                <div class="d-flex align-items-center  anim-2" data-anim-visible='fade'>
                                    ...
                                    <button class="btn-fab btn-white ms-3" data-bs-toggle="modal"
                                        data-bs-target="#messageModal">
                                        <span class="icon"><i class="ion-md-mail"></i></span>
                                    </button>
                                </div>
                                <p class="anim-3" data-anim-visible='fade'>Feel free to ask us any questions related to
                                    our activities.
                                    We will be happy
                                    to answer you.</p>
                            </div>
                    ...
                    <div class="row mt-4 anim-4">
                        <div class="col-12 col-lg-4 mb-4 text-left">
                            <div itemprop="department" itemscope itemtype="https://schema.org/Place"
                                data-anim-visible='fade'>
                                <h4 class="dep-name" itemprop="name">
                                    <strong>Antartica Office</strong>
                                </h4>
                                <div class="dep-address" itemprop="address" itemscope
                                    itemtype="https://schema.org/PostalAddress">
                                    <div class="addr-line">Phone: <span itemprop="telephone">(0)123-456-7890</span>
                                    </div>
                                    <div class="addr-line">
    ...
    <!-- required by fullpage js and image slideshow -->
    <script src="https://cdn.killercloud.com.au/web/js/jquery/jquery-1.12.4.min.js"></script>

    <!-- required by fullpage JS -->
    <script src="https://cdn.killercloud.com.au/web/js/fullpage/scrolloverflow.min.js"></script>
    <script src="https://cdn.killercloud.com.au/web/js/fullpage/jquery.fullpage.min.js"></script>
    <script src="https://cdn.killercloud.com.au/web/js/init-fullpage.js"></script>

    <!-- required by image bg slideshow -->
    <script src="https://cdn.killercloud.com.au/web/js/vegas/vegas.min.js"></script>
    <script src="https://cdn.killercloud.com.au/web/js/init-slideshow.js"></script>
